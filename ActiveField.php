...
class ActiveField extends \yii\widgets\ActiveField
{
    ...
    public function dropDownList($items, $browserDefault = false, $options)
    {
        if ($browserDefault) {
    ...
    public function radio($options = [], $withGap = false, $enclosedByLabel = true)
    {
        if ($withGap) {
    ...
    public function radioList($items, $options = [], $withGap = false)
    {
        if ($withGap) {
    ...
    public function checkbox($options = [], $filled = false, $enclosedByLabel = true)
    {
        if ($filled) {
    ...
    public function checkboxList($items, $filled = false, $options = [])
    {
        if ($filled) {
            $this->addListInputCssClass($options, $this->checkboxFilledCssClass);
        }
        return parent::checkboxList($items, $options); // TODO: Change the autogenerated stub
    }
